...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('cloud_topic', default_value="/lidar/points", description="a pointcloud topic to process",),
        DeclareLaunchArgument('cloud_frame', default_value="lidar", description="a pointcloud topic to process",),
