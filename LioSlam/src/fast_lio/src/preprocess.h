...
#include <livox_ros_driver2/msg/custom_msg.hpp> // Assumed ROS 2 driver
...
enum Surround{Surround_Prev, Surround_Next};
...
struct orgtype
{
  ...
  orgtype()
  {
    range = 0;
    // 修改这里
    edj[Surround_Prev] = Nr_nor;
    edj[Surround_Next] = Nr_nor;
    ftype = Nor;
    intersect = 2;
  }
};
...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  // ROS 2: Use ConstSharedPtr for message callbacks
