...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('cloud_topic', default_value="/pointclouds", description="a pointcloud topic to process",),
        DeclareLaunchArgument('cloud_frame', default_value="odom", description="a pointcloud topic to process",),
        ...
        Node(
            ...
            parameters=[
                ...
                {'th_dist': 0.3},          # threshold for thickenss of ground.
                ...
                {'min_range': 10.0},             # max_range of ground estimation area
                {'min_range': 0.0},              # min_range of ground estimation area
                {'uprightness_thr': 0.4},    # threshold of uprightness using in Ground Likelihood Estimation(GLE). Please refer paper for more information about GLE.
