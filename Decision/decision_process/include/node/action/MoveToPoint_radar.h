...
class MoveToPoint_radar: public StatefulActionNode{
private:
    vector<pair<double, double>> points;
    int current_index = 0;
    int staying_time = 4000 ;
    zh_timer staying{4000};

public:

    MoveToPoint_radar(const string& name, const NodeConfig& config): StatefulActionNode(name, config)
    {        
        
    }

    ~MoveToPoint_radar() override = default;
