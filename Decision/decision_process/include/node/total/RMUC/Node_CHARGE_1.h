...
class Node_CHARGE_1 : public  SyncActionNode 
{
public:
    Node_CHARGE_1(const string &name, const NodeConfig &config) : SyncActionNode(name, config) 
    {charge_timer.reset();defence_timer.reset();}
    
    ~Node_CHARGE_1() override = default;
