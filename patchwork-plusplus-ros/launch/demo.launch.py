...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('cloud_topic', default_value="/odin1/cloud_raw", description="a pointcloud topic to process",),
        DeclareLaunchArgument('cloud_frame', default_value="odin1_base_link", description="a pointcloud topic to process",),
        ...
        Node(
            ...
            parameters=[
                ...
                {'max_range': 10.0},             # max_range of ground estimation area
